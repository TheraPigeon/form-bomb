    ...
    describe('the UI', function () {
        it('should render a "Create Form" button', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(FormBuilder, {}, void 0));
                        return [4 /*yield*/, screen.findByText(defaults.submitText)];
                    case 1:
                        button = _a.sent();
        ...
        it('should render a header containing title and description options', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(FormBuilder, {}, void 0));
                        return [4 /*yield*/, screen.findByRole('textbox', { name: 'title' })];
                    case 1:
                        titleInput = _a.sent();
                        return [4 /*yield*/, screen.findByRole('textbox', {
                                name: 'description',
                            })];
                    case 2:
    ...
    describe('the create button', function () {
        ...
        it('should display text "Create Form" when a config object missing meta.submitText field is passed', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        render(_jsx(FormBuilder, { config: { meta: {} } }, void 0));
                        return [4 /*yield*/, screen.findByText(defaults.submitText)];
                    case 1:
                        button = _a.sent();
                        expect(button).toBeInTheDocument();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        render(_jsx(FormBuilder, { config: { meta: { submitText: submitText } } }, void 0));
                        return [4 /*yield*/, screen.findByText(submitText)];
                    case 1:
                        button = _a.sent();
                        expect(button).toBeInTheDocument();
                        return [2 /*return*/];
                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, act(function () { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            render(_jsx(FormBuilder, { onSubmit: submit }, void 0));
                                            return [4 /*yield*/, screen.findByText(defaults.submitText)];
                                        case 1:
                                            button = _a.sent();
                                            user.click(button);
        ...
        it('should pass the resulting BombConfig object to the submit callback function', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        val = __assign(__assign({}, cloneDeep(defaultBomb)), { meta: { title: 'mockTitle' } });
                                    ...
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, waitFor(function () { return __awaiter(void 0, void 0, void 0, function () {
                                                    ...
                                                    return __generator(this, function (_a) {
                                                        switch (_a.label) {
                                                            case 0: return [4 /*yield*/, screen.findByText(defaults.submitText)];
                                                            case 1:
                                                                button = _a.sent();
