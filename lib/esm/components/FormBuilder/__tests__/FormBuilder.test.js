            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, screen.findByText(defaultSubmitButtonText)];
                    case 1:
                        button = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        render(_jsx(FormBuilder, { config: { meta: { submitButtonText: submitText } } }, void 0));
        ...
        it('should call the submit function from props when clicked', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        submit = jest.fn();
                        render(_jsx(FormBuilder, { submit: submit }, void 0));
                        return [4 /*yield*/, screen.findByText(defaultSubmitButtonText)];
                    case 1:
                        button = _a.sent();
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, waitFor(function () { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, screen.findByText(defaultSubmitButtonText)];
                                        case 1:
                                            button = _a.sent();
                                            fireEvent.click(button);
                                            return [2 /*return*/];
