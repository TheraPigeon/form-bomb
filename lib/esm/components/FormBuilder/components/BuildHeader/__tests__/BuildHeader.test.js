...
describe('BuildHeader', function () {
    ...
    it('Displays a default form title when no title props is passed', function () {
        renderWithFormikBuild(_jsx(BuildHeader, {}, void 0), onSubmit);
        expect(screen.getByRole('textbox', { name: 'title' })).toHaveValue(defaults.formTitle);
    });
    it('Displays a custom form title when title prop is passed', function () {
        var customTitle = 'Custom Title';
        var values = cloneDeep(defaultBomb);
        values.meta.title = customTitle;
        renderWithFormikBuild(_jsx(BuildHeader, {}, void 0), onSubmit, values);
        expect(screen.getByRole('textbox', { name: 'title' })).toHaveValue(customTitle);
    });
    it('Displays a default form description when no description props is passed', function () {
        renderWithFormikBuild(_jsx(BuildHeader, {}, void 0), onSubmit);
        expect(screen.getByRole('textbox', { name: 'description' })).toHaveValue(defaults.formDescription);
    });
    it('Displays a custom form description when description prop is passed', function () {
        ...
        renderWithFormikBuild(_jsx(BuildHeader, {}, void 0), onSubmit, values);
        expect(screen.getByRole('textbox', { name: 'description' })).toHaveValue(customDescription);
    });
    it('Displays the updated title value when the user types in the title input', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    values = __assign(__assign({}, cloneDeep(defaultBomb)), { meta: { title: '', description: '' } });
                    newTitle = 'New Title';
                    findByRole = renderWithFormikBuild(_jsx(BuildHeader, {}, void 0), onSubmit, values).findByRole;
                    return [4 /*yield*/, findByRole('textbox', { name: 'title' })];
                case 1:
                    input = _a.sent();
                    return [4 /*yield*/, user.type(input, newTitle, { delay: 1 })];
                case 2:
                    _a.sent();
    ...
    it('Displays the updated description value when the user types in the description input', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    input = _a.sent();
                    return [4 /*yield*/, user.type(input, newDescription, { delay: 1 })];
                case 2:
                    _a.sent();
...
//# sourceMappingURL=BuildHeader.test.js.map