...
var FormBuilderContainer = function (_a) {
    var _b = _a.config, config = _b === void 0 ? defaultBuilderConfig : _b, _c = _a.submit, submit = _c === void 0 ? function (bomb) { } : _c;
    var _d = useState(defaultBomb), bomb = _d[0], setBomb = _d[1];
    var submitFn = function () {
        submit(bomb);
    };
    return _jsx(FormBuilderView, { config: config, submit: submitFn }, void 0);
};
