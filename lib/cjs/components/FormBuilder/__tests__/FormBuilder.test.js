            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, react_1.screen.findByText(config_1.defaultSubmitButtonText)];
                    case 1:
                        button = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        react_1.render(jsx_runtime_1.jsx(index_1.default, { config: { meta: { submitButtonText: submitText } } }, void 0));
        ...
        it('should call the submit function from props when clicked', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        submit = jest.fn();
                        react_1.render(jsx_runtime_1.jsx(index_1.default, { submit: submit }, void 0));
                        return [4 /*yield*/, react_1.screen.findByText(config_1.defaultSubmitButtonText)];
                    case 1:
                        button = _a.sent();
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, react_1.waitFor(function () { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, react_1.screen.findByText(config_1.defaultSubmitButtonText)];
                                        case 1:
                                            button = _a.sent();
                                            react_1.fireEvent.click(button);
                                            return [2 /*return*/];
