...
var FormBuilderContainer = function (_a) {
    var _b = _a.config, config = _b === void 0 ? config_1.default : _b, _c = _a.onSubmit, onSubmit = _c === void 0 ? function (bomb) { } : _c;
    var _d = react_1.useState(config_1.defaultBomb), bomb = _d[0], setBomb = _d[1];
    var submitFn = function () {
        onSubmit(bomb);
    };
    return jsx_runtime_1.jsx(FormBuilderView_1.default, { config: config, onSubmit: submitFn }, void 0);
};
