...
var Item = function (_a) {
    ...
    if (item.type === interfaces_1.BombItemType.SECTION) {
        return jsx_runtime_1.jsx(Section_1.default, { position: position, item: item }, void 0);
    }
    else if (item.type === interfaces_1.BombItemType.QUESTION) {
        switch (item.format) {
            case interfaces_1.BombItemFormat.MULTIPLE_CHOICE:
                return jsx_runtime_1.jsx(questions_1.MultipleChoice, { position: position, item: item }, void 0);
            default:
                return jsx_runtime_1.jsx(questions_1.MultipleChoice, { position: position, item: item }, void 0);
        }
    }
